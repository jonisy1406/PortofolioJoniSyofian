(function () {
  ...
  const translations = {
    id: {
      ...
      "landing.eyebrow": "Asisten SQL rule-based",
      ...
      "landing.pythonCopy": "Logika utama ditulis dalam Python dan dijalankan di browser memakai Pyodide.",
      ...
      "optimizer.summaryTitle": "Ringkasan Analisis",
    ...
    en: {
      ...
      "landing.eyebrow": "Rule-based SQL assistant",
      ...
      "landing.optimizeTitle": "Optimize SQL",
      "landing.pythonCopy": "The main logic is written in Python and runs in the browser through Pyodide.",
      ...
      "optimizer.summaryTitle": "Analysis Summary",
      "optimizer.title": "Optimize SQL",
